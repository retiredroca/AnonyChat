...
async function importSigningPrivKey(pem) {
  ...
  // Try all supported algorithms so keys generated by any previous version
  // of this app (P-256, P-384, RSA-PSS 2048) can still be imported.
  // New keys are always generated as P-384.
  const candidates = [
  ...
  throw new Error('Unrecognised key. Paste the full PKCS#8 PEM including -----BEGIN/END PRIVATE KEY----- lines.');
}
